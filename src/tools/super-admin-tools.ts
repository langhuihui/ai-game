...
export class SuperAdminTools {
  ...
  private async updateCharacterIdentity(args: any, context?: RequestContext): Promise<any> {
  ...
  private async createScene(args: any, context?: RequestContext): Promise<any> {
  ...
  private async createItem(args: any, context?: RequestContext): Promise<any> {
  ...
  private async sendAnnouncement(args: any, context?: RequestContext): Promise<any> {
  ...
  private async modifyCharacter(args: any, context?: RequestContext): Promise<any> {
