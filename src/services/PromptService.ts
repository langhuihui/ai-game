...
export class PromptService {
  ...
  private generateCharacterAnalysisPrompt(args: any): PromptMessage[] {
...
请提供详细、深入的分析报告。`
  ...
  private generateSceneDescriptionPrompt(args: any): PromptMessage[] {
...
请用生动的语言创造一个沉浸式的场景体验。`
  ...
  private generateWorldStatusPrompt(): PromptMessage[] {
    return [
      {
        role: 'system',
        content: {
...
请提供一个专业、详细的状态报告。`
  ...
  private generateCharacterInteractionPrompt(args: any): PromptMessage[] {
...
请创建一个引人入胜的互动场景。`
  ...
  private generateQuestGenerationPrompt(args: any): PromptMessage[] {
...
请设计一个有趣、有挑战性且符合角色特点的任务。`
  ...
  private generateMemoryAnalysisPrompt(args: any): PromptMessage[] {
    const characterName = args.character_name;
    return [
      {
        role: 'system',
...
请提供专业的心理分析报告。`
  ...
  private generateTradeNegotiationPrompt(args: any): PromptMessage[] {
...
请创造一个真实、有趣的交易谈判场景。`
  ...
  private generateCitizenshipReviewPrompt(args: any): PromptMessage[] {
...
请提供客观、专业的审查报告。`
  ...
  private generatePermissionAuditPrompt(): PromptMessage[] {
    return [
      {
        role: 'system',
        content: {
...
请提供详细的审计报告和改进建议。`
  ...
  private generateGameNarrativePrompt(args: any): PromptMessage[] {
