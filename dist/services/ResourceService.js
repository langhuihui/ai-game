...
export class ResourceService {
     ...
     * 辅助方法：获取角色按场景分组
     */
    getCharactersByScene(characters) {
        const sceneGroups = {};
     ...
     * 获取单个角色的完整资源
     */
    async getCharacterResource(characterName) {
     ...
     * 获取单个场景的完整资源
     */
    async getSceneResource(sceneName) {
     ...
     * 获取角色的所有记忆资源
     */
    async getCharacterMemoriesResource(characterName) {
        const character = this.characterService.getCharacterByName(characterName);
        if (!character) {
            throw new Error(i18n.t('errors.characterNotFound', { name: characterName }));
        }
     ...
     * 获取角色的活动历史资源
     */
    async getCharacterActivityResource(characterName) {
        const character = this.characterService.getCharacterByName(characterName);
        if (!character) {
            throw new Error(i18n.t('errors.characterNotFound', { name: characterName }));
        }
     ...
     * 获取角色的基本信息资源
     */
    async getCharacterBasicInfoResource(characterId) {
     ...
     * 获取公民申请状态资源
     */
    async getCitizenshipApplicationResource(characterId) {
