...
export class GameInteractionTools {
    ...
    async respondToTradeOffer(args) {
    ...
    async markAllMessagesAsRead(args) {
...
//# sourceMappingURL=game-interaction-tools.js.map