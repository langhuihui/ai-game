...
export class SuperAdminTools {
    ...
    async modifyCharacter(args, context) {
        ...
        if (mental_state !== undefined)
            updates.mental_state = mental_state;
    ...
    async reviewCitizenshipApplication(args, context) {
    ...
    async listCitizenshipApplications(args, context) {
...
//# sourceMappingURL=super-admin-tools.js.map